...
GAMES=('shikaku','parking','power','warehouse','untangle','light','fishing','runner','memory','tower','territory','dodge','work','blackjack','slot','baccarat','horse_race','seotda','coin','minesweeper','supply_drop','duckmong','rock_paper_scissors','number_baseball','all_in','aim','pubg','reaction','stopwatch','fortune','stocks','apple','snake','suika','2048')
